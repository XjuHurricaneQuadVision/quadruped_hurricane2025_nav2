...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory("quadruped_nav2_bringup")
    ...
    declare_world_cmd = DeclareLaunchArgument(
        ...
        description="Select world,map file share the same name as the this parameter",
    )
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            bringup_dir, "config", "quadruped_nav2_params.yaml"
        ),
    ...
    start_robot_state_publisher_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(launch_dir, "quadruped_state_publisher_launch.py")
        ),
